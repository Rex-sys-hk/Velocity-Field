...
from utils.data_augmentation.data_augmentation_util import ParameterToScale
from utils.data_augmentation.nuplan_utils.abstract_model_feature import FeaturesType, TargetsType, AbstractModelFeature
...
class AbstractAugmentor(ABC):
    ...
    @abstractmethod
    def augment(
        self, features: FeaturesType, targets: TargetsType, scenario: Optional[AbstractModelFeature] = None
